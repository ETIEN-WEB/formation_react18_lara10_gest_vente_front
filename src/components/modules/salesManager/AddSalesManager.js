...
const AddSalesManager = () => {
    ...
    const getShops = () => {
        axiosClient.get('/get-shop-list').then(res=>{
            setShops(res.data)
        })
    }
    ...
    const handleSalesManagerCreate = () => {
        setIsLoading(true)
        axiosClient.post('/sales-manager', input).then(res=>{
            setIsLoading(false)
            Swal.fire({
                position: "top-end",
                icon: res.data.cls,
    ...
    return (
        <>
            <BreadCrumb title={'Ajouter une vente'} />
            <div className="row ">
                                                ...
                                                <div className='row'>
                                                    <div className="col-6">
                                                        <div className="nid_photo-preview mt-3">
                                                            <img src={input.nid_photo} alt={'Photo preview'} className={'img-thumbnail aspect-one'} />
                                                        </div>
                                                    </div>
                                                </div> : null
                                            }
