...
const ShopEdit = () => {
    ...
    const getShop = () => {
        axiosClient.get(`/shop/${params.id}`).then(res=>{
    ...
    const handleShopUpdate = () => {
        setIsLoading(true)
        axiosClient.put(`/shop/${params.id}`, input).then(res=>{
            setIsLoading(false)
            Swal.fire({
                position: "top-end",
                icon: res.data.cls,
    ...
    return (
        <>
            <BreadCrumb title={'Modifier une boutique'} />
            <div className="row ">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <label className={'w-100 mt-4'}>
                                                ...
                                                <textarea
                                                    ...
                                                    value={input.details}
                                                    onChange={handleInput}
                                                    placeholder={'Détails sur la boutique'}
                                                />
                                ...
                                <div className="col-md-6">
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <label className={'w-100 mt-4'}>
                                                <p>Choisir la division de la boutique </p>
                                                <select
                                            ...
                                            <label className={'w-100 mt-4'}>
                                                <p>Choisir la ville de la boutique </p>
                                                <select
                                            ...
                                            <label className={'w-100 mt-4'}>
                                                <p>Choisir le quartier de la boutique </p>
                                                <select
                                    ...
                                    <div className="row justify-content-center">
                                        <div className="col-md-4">
                                            <div className={'d-grid mt-4'}>
                                                <button className={'btn theme-button'} onClick={handleShopUpdate} dangerouslySetInnerHTML={{__html: isLoading ? ' <span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span> Chargement... ' : ' Modifier une boutique ' }}/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
