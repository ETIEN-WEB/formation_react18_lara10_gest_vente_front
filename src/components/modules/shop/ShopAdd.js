...
const ShopAdd = () => {
    ...
    const handleShopCreate = () => {
        setIsLoading(true)
        axiosClient.post('/shop', input).then(res=>{
            setIsLoading(false)
            Swal.fire({
                position: "top-end",
                icon: res.data.cls,
    ...
    return (
        <>
            <BreadCrumb title={'Ajouter une boutique'} />
            <div className="row ">
                                        ...
                                        <div className="card-body">
                                            <label className={'w-100'}>
                                                ...
                                                <input
                                                    ...
                                                    value={input.address}
                                                    onChange={handleInput}
                                                    placeholder={"Entrer l'adresse de la bouitque"}
                                                />
                                    ...
                                    <div className="row justify-content-center">
                                        <div className="col-md-4">
                                            <div className={'d-grid mt-4'}>
                                                <button className={'btn theme-button'} onClick={handleShopCreate} dangerouslySetInnerHTML={{__html: isLoading ? ' <span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span> Chargement... ' : ' Ajouter une boutique ' }}/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
